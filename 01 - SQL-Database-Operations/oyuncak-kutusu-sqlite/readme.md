## Bölüm 1 – Tablo kurma 
### oyuncaklar adında bir tablo oluştur. Şu sütunlar olsun: id: otomatik artan numara -- isim: yazı, boş bırakılamaz -- cesit: yazı -- fiyat: sayı, 0'dan büyük olmalı -- renk: yazı, yazılmazsa kırmızı olsun
